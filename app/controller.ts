 ...
 */
const addMapping = (router: Router, mapping: any) => {
 ...
 */
const fileDisplaySync = (filePath: string): void => {
 ...
 * 如果是文件夹则递归找出文件夹下的文件.
 */
const addControllers = (router: Router, dir: string) => {
// function addControllers(router: Router, dir: string) {
    // 筛选出文件到`fileArr`中
